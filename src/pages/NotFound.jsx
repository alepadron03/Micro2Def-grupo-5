            ...
            <Navbar/>
                ...
                <div className="flex flex-wrap justify-center gap-4">
                    <div className="w-full md:w-1/3 relative rounded-b-lg overflow-hidden">
                        <img className="w-full h-64 object-cover rounded-b-lg" src="imagenes/SabasNieveImagen2.png" alt="Piedra 1" />
                    </div>
                    <div className="w-full md:w-1/3 relative rounded-b-lg overflow-hidden">
                        <img className="w-full h-64 object-cover rounded-b-lg" src="imagenes/SabasNieveImagen3.png" alt="Piedra 2" />
                    </div>
                    <div className="w-full md:w-1/3 relative rounded-b-lg overflow-hidden">
                        <img className="w-full h-64 object-cover rounded-b-lg" src="imagenes/SabasNieveImagen4.png" alt="Piedra 3" />
                    </div>
                    </div>
